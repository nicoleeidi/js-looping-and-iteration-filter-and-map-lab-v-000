...
function exactMatch(driver,object){ //returned no matched
  return driver.filter(function(person){return person.name== object.name || return person.revenue == object.name})
}
function exactMatchToList(driver,object){
  filteredDriver= driver.filter(function(person){return person.name== object.name || return person.revenue == object.name})
